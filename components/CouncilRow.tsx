  ...
  return (
    <div className={`w-full p-4 rounded-xl border-l-4 border ${colorClass} ${bgClass} transition-all hover:translate-x-1 duration-300 mb-3`}>
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex sm:flex-col items-center sm:items-start gap-2 sm:w-32 shrink-0 border-b sm:border-b-0 sm:border-r border-slate-200/50 pb-2 sm:pb-0 sm:pr-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {data.conflict_point && (
              <div className="flex items-start gap-2 bg-black/10 p-2 rounded-lg border border-white/5">
                ...
                <div>
                  <span className="text-[10px] font-bold text-amber-500/80 uppercase block">Friction</span>
            ...
            {data.benevolence_check && (
              <div className="flex items-start gap-2 bg-black/10 p-2 rounded-lg border border-white/5">
                ...
                <div>
                  <span className="text-[10px] font-bold text-emerald-400/80 uppercase block">Benevolence</span>
